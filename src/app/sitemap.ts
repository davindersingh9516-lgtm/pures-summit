...
import { getAllBlogPostSlugs, getAllPageSlugs, getAllProductSlugs, getCategories } from "@/services";
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const [pageSlugs, productSlugs, blogSlugs, categories] = await Promise.all([
    getAllPageSlugs(),
    getAllProductSlugs(),
    getAllBlogPostSlugs(),
    getCategories(),
