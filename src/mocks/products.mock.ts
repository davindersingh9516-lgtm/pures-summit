...
export const mockProducts: Product[] = [
  {
    ...
    images: [{ id: "img-1", url: "/mocks/product-jar.png", altText: "Pure Summit Manuka Honey jar, UMF 10+" }],
  ...
  },
  {
    ...
    price: nzd(59.9),
    stockStatus: "IN_STOCK",
    images: [{ id: "img-2", url: "/mocks/product-jar.png", altText: "Pure Summit Manuka Honey jar, UMF 15+" }],
  ...
  },
  {
    ...
    price: nzd(109.9),
    stockStatus: "IN_STOCK",
    images: [{ id: "img-3", url: "/mocks/product-jar.png", altText: "Pure Summit Manuka Honey jar, UMF 20+" }],
    categories: [byslug("raw-manuka-honey"), byslug("umf-graded")],
  ...
  },
  {
    ...
    price: nzd(29.9),
    stockStatus: "IN_STOCK",
    images: [{ id: "img-5", url: "/mocks/product-jar.png", altText: "Pure Summit Manuka Honey jar, UMF 5+" }],
  ...
  },
  {
    ...
    price: nzd(79.9),
    stockStatus: "IN_STOCK",
    images: [{ id: "img-6", url: "/mocks/product-jar.png", altText: "Pure Summit Manuka Honey jar, MGO 550+" }],
    categories: [byslug("umf-graded")],
  ...
  },
  {
    ...
    price: nzd(34.9),
    stockStatus: "IN_STOCK",
    images: [{ id: "img-7", url: "/mocks/product-jar.png", altText: "Pure Summit Manuka Honey jar, UMF 8+" }],
    categories: [byslug("raw-manuka-honey")],
  ...
  },
  {
    ...
    price: nzd(159.9),
    stockStatus: "IN_STOCK",
    images: [{ id: "img-8", url: "/mocks/product-jar.png", altText: "Pure Summit Manuka Honey jar, UMF 24+" }],
    categories: [byslug("raw-manuka-honey"), byslug("umf-graded")],
  ...
  },
  {
    ...
    price: nzd(139.0),
    stockStatus: "IN_STOCK",
    images: [{ id: "img-4", url: "/mocks/product-jar.png", altText: "Pure Summit Manuka Honey Discovery Gift Set" }],
